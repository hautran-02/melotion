...
public class SharedPrefManager {
    ...
    public User getUser () {
        ...
        return new User(
                ...
                sharedPreferences.getString(KEY_PHONE, null), sharedPreferences.getString(KEY_EMAIL, null),
                sharedPreferences.getString(KEY_FIRSTNAME, null), sharedPreferences.getString(KEY_LASTNAME, null)
        );
    }
    public void logout () {
        SharedPreferences sharedPreferences = ctx.getSharedPreferences(SHARED_PREF_NAME, Context.MODE_PRIVATE);
